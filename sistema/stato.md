...
- Risposte automatiche per parola chiave (INFO): non disponibili in Meta Business Suite per questo account. La risposta automatica parte al primo messaggio di chiunque, qualunque cosa scriva.
...
- Bozze: Alessandro le vuole in anticipo, non a ridosso della pubblicazione (detto il 18/09).
...
- Nessun commento in attesa di risposta al 18/09 mattina.

## Da fare lato Alessandro
- Riscontro sulla bozza del carosello Prima visita.
