...
- Link in bio: sito professionale (Canva, poi nuovo sito Lovable).
...
- DM: la risposta automatica (Auto reply) di Meta Business Suite va DISATTIVATA. Decisione di Alessandro del 19/09: partiva al primo messaggio di chiunque, anche a chi non chiedeva informazioni. Le risposte per parola chiave (INFO) non esistono in Meta Business Suite per questo account (verificato 17/09); una vera automazione a parola chiave richiede uno strumento esterno tipo ManyChat, da decidere. Sostituzione proposta: Domande frequenti nei DM (bottoni che la persona tocca) piu' risposta salvata con scorciatoia "info". Bozza in sistema/bozze/domande_frequenti.md.
...
- Post fissati: 1) "Chi sono" del 19/05 (resta), 2) Recensioni del 17/09 (fissato il 18/09), 3) da decidere a ridosso (proposta: carosello Prima visita).
...
- Confermato: copertina con il volto di Alessandro piu' prova sociale funziona. Il carosello Recensioni in due ore ha superato le interazioni del plicometro in quattordici. Si tiene su tutti i prossimi post.
- Commenti semplici (solo emoji, complimenti senza domanda): Alessandro li gestisce da solo con un cuore dall'app, e Windsor non lo vede. Prima di proporre una risposta scritta a un commento del genere, chiedere se lo ha gia' sistemato invece di preparare la bozza.
...
- Domande frequenti nei DM e risposta salvata "info": bozza del 19/09 in sistema/bozze/domande_frequenti.md. In attesa dell'ok.
...
- In attesa dell'ok sulle Domande frequenti; da decidere se valutare uno strumento esterno per le parole chiave.
...
- Dopo l'ok: inserire le Domande frequenti dall'app Instagram e la risposta salvata con scorciatoia "info".
