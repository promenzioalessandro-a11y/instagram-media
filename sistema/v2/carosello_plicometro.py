...
im = FT.sfuma(im, 560, 1180, forza=0.9)
d = ImageDraw.Draw(im)
FT.intestazione_foto(d, 1, N)
R.occhiello(d, (M, 790), "Dentro la visita", C["navy300"])
y = R.blocco(d, (M, 842), "Cosa misura davvero il plicometro?", 600, 96, bianco, tw, 1.04, -0.028)
R.blocco(d, (M, y + 26), "Spoiler: non il peso.", 400, 40, (225, 230, 238), tw, 1.4)
FT.piede_foto(d)
salva(im, 1)
...
R.pillola(d, (M, yb + 44), "Scrivimi INFO in DM", C["azione_scuro"], C["azione_scuro_testo"])
